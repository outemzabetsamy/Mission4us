...
import com.sundev.mission4us.repository.JobRepository;
import com.sundev.mission4us.service.dto.JobDTO;
import com.sundev.mission4us.service.mapper.JobMapper;
...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().name(DEFAULT_NAME);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().name(UPDATED_NAME);
        return job;
    }
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.name(UPDATED_NAME);
